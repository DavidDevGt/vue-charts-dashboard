<template>
  <v-navigation-drawer v-model="drawer" color="#425C5A" class="rounded-e-xl">
    <v-sheet color="#3D5654" class="pa-4 rounded-te-xl text-center">
      ...
      <div class="mt-4">DavidDevGt</div>
      <span class="mb-6 text-captoin">davidwebgt@gmail.com</span>
    </v-sheet>
    <v-list>
      <v-list-item
    ...
    <v-row align="center" class="spacer ml-16 mt-4" no-gutters>
      <v-col cols="4" sm="2" md="1">
        <v-avatar size="36px">
          <v-img alt="Avatar" src="1.png"></v-img>
        </v-avatar>
      </v-col>
      <v-col cols="4" sm="2" md="1">
        <v-avatar size="36px">
          <v-img alt="Avatar" src="2.png"></v-img>
        </v-avatar>
      </v-col>
      <v-col cols="4" sm="2" md="1">
        <v-avatar size="36px">
          <v-img alt="Avatar" src="3.png"></v-img>
        </v-avatar>
      </v-col>
      <v-col cols="4" sm="2" md="1">
        <v-avatar size="36px">
          <v-img alt="Avatar" src="4.png"></v-img>
        </v-avatar>
      </v-col>
      <v-col cols="4" sm="2" md="1">
